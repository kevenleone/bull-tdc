    ...
    <div>
      ...
      <ClayForm className='mt-5'>
        ...
        <ClayLayout.Row className='mt-4'>
          <ClayLayout.Col>
            <ClayButton displayType="unstyled" className='btn-link'>Create Account</ClayButton>
          </ClayLayout.Col>
          <ClayLayout.Col style={{ textAlign: 'end' }}>
            <ClayButton displayType="unstyled" className='btn-link'>Forgot Password</ClayButton>
          </ClayLayout.Col>
        </ClayLayout.Row>
      </ClayForm>
    </div>
